  ...
  async function handleToggleHabit(habitId: string) {
    ...
    setHabitsInfo(prevState => {
      ...
      if (isHabitAlreadyCompleted) {
        completedAmount = prevState!.completedHabits.filter(id => id !== habitId)
      } else {
        completedAmount = [...prevState!.completedHabits, habitId]
      }

      onCompletedChange(completedAmount.length);

      return ({
        ...prevState!,
        completedHabits: completedAmount
      })
    })
  }
